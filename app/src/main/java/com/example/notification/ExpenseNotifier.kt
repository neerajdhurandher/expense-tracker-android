...
object ExpenseNotifier {
    ...
    fun showExpenseNotification(context: Context, parsedSms: ParsedSms, category: String) {
        Log.d(TAG, "Showing expense notification — ₹${parsedSms.amount} at ${parsedSms.merchant} ($category)")
        ...
        val editPendingIntent = PendingIntent.getActivity(
            context, 2, editIntent,
            PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE
        )

        // Skip action — just dismisses the notification
        ...
        try {
            ...
            Log.i(TAG, "✅ Heads-up notification posted — ₹${parsedSms.amount} at ${parsedSms.merchant}")
